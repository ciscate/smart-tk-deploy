...
export function TicketVoucherEdit({
    id,
    onSubmit,
    register,
    errors,
    ...
    return (
        <div className="flex items-center justify-center bg-purple-200 rounded-lg p-2 border border-gray-400">
            ...
            <div className="flex flex-col items-center">
                ...
                <h1 className="text-3xl font-semibold mb-14 mt-4 text-center text-gray-700">
                    {id ? "EDITAR COMPROBANTES" : "CREAR NUEVO TICKET"}
                </h1>
                ...
                <form onSubmit={onSubmit} className="space-y-9">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full p-3 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-300 text-xl"
                        />
                        {errors.title && (
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full p-3 border border-gray-300 rounded-lg bg-gray-50 resize-none focus:outline-none focus:ring-2 focus:ring-purple-300 text-xl"
                            disabled={!canEdit}
                        ></textarea>
                        {errors.description && (
                        ...
                        <>
                            <div>
                                ...
                                <input
                                    ...
                                    multiple
                                    className="w-full p-1 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-400"
                                />
                            </div>
