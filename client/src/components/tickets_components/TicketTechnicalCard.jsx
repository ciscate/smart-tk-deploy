...
export function TicketTechnicalCard({ ticket }) {
    ...
    return (
        <div
            className="bg-red-200 p-6 rounded-lg shadow-lg border border-gray-300 hover:bg-red-300 transition cursor-pointer"
            onClick={() => {
                navigate(`/edit-tickettechnical/${ticket.id}`);
            }}
        >
            <h1
            ...
            {isAdmin ? (
                ...
                <>
                    ...
                    {ticket.user ? (
                        ...
                        <p className="text-gray-600 text-lg">Usuario: Usuario desconocido</p>
                    )}
                </>
            )}
        </div>
