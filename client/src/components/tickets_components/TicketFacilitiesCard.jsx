...
export function TicketFacilitiesCard({ ticket }) {
    ...
    return (
        <div
            className="bg-blue-200 p-6 rounded-lg shadow-lg border border-gray-300 hover:bg-blue-300 transition cursor-pointer"
            onClick={() => {
                navigate(`/edit-ticketfacilities/${ticket.id}`);
            }}
        >
            <h1
