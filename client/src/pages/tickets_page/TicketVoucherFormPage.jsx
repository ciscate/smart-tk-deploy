...
import { createTicketVoucher } from "../../api/tickets_api/ticketsvoucher.api";
...
export function TicketVoucherFormPage() {
    const { register,
        handleSubmit,
        formState: { errors },
        setError,
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        try {
            await createTicketVoucher(formData, {
    ...
    return (
        <div className="flex items-start mx-auto w-3/5 justify-between min-h-screen bg-purple-100 p-6 rounded-lg mt-12">
            {/* Sección de búsqueda */}
            <div className="w-2/4 bg-white p-6 rounded-lg shadow-lg border-2 border-gray-300 space-y-5 mr-6">
                ...
                <input
                    ...
                    className="w-full p-3 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-400 text-xl"
                />
                    ...
                    {searchTerm &&
                        filteredClients.map((cliente, index) => (
                            ...
                            >
                                ...
                                {/* Botón "+" */}
                                <button
                                    className="flex items-center justify-center w-10 h-10 rounded-full bg-purple-500 text-white font-bold text-xl hover:bg-purple-600 transition duration-300"
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                    ...
                    <div>
                            ...
                            <input 
                                ...
                                multiple
                                className="w-full p-3 border rounded-full bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-400 text-gray-700"
                            />
                        </div>
                        <div className="mt-4">
                    ...
                    {/* Botón de guardar */}
                    <button className="border border-purple-500 text-purple-500 p-3 rounded-lg w-full hover:bg-purple-500 hover:text-white transition duration-300">
                        GUARDAR
                    </button>
                </form>
            </div>
