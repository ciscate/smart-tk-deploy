...
import {
    ...
    updateTicketVoucher,
    deleteTicketVoucher,
} from "../../api/tickets_api/ticketsvoucher.api";
import { useNavigate, useParams } from "react-router-dom";
import { getStaffUsers } from "../../api/users_api/usersapi";
import { useForm } from "react-hook-form";
import { toast } from "react-hot-toast";
import { TicketVoucherEdit } from "../../components/tickets_components/TicketVoucherEdit";
...
export function TicketVoucherDetailPage() {
    const { id } = useParams();
    const {
        register,
        handleSubmit,
    ...
    useEffect(() => {
        if (id) {
            async function loadTicketVoucher() {
                try {
                    const response = await getTicketVoucher(id);
    ...
    const onSubmit = handleSubmit(async (formData) => {
        ...
        try {
            const response = await updateTicketVoucher(id, data, {
                ...
                {ticket ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex flex-col items-center justify-center space-y-6">
                            <div className="bg-purple-200 p-6 rounded-lg border border-gray-400 text-gray-800 w-full shadow">
                                    ...
                                    <div className="flex flex-col space-y-2 ">
                                        ...
                                        {userData.is_superuser || userData.is_staff ? (
                                            <textarea
                                                ...
                                                className="w-full p-4 border border-purple-300 rounded-lg bg-gray-50 text-xl resize-none focus:outline-none focus:ring-2 focus:ring-purple-300"
                                                rows="4"
                                            ...
                                            <div
                                                id="observation"
                                                className="w-full p-4 border border-purple-300 rounded-lg bg-gray-50 text-xl"
                                            >
                                            ...
                                            <div className="flex flex-col space-y-2">
                                                ...
                                                {userData.is_superuser || userData.is_staff ? (
                                                    <select
                                                        ...
                                                        className="w-full p-4 border border-purple-300 rounded-lg bg-gray-50 text-xl text-center focus:outline-none focus:ring-2 focus:ring-purple-300"
                                                    >
                                                    ...
                                                    <div
                                                        id="status"
                                                        className="w-full p-4 border border-purple-300 rounded-lg bg-gray-50 text-xl text-center"
                                                    >
                                                        {newStatus}{" "}
