...
class TicketFacilitiesSerializer(serializers.ModelSerializer):
    ...
    # Agregar el nuevo campo de observación
    ...
    def create(self, validated_data):
        ...
        ticket = TicketFacilities.objects.create(**validated_data)
        if client_data:
